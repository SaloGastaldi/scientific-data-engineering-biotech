...
# -*- coding: utf-8 -*-
"""
Created on Fri May 28 16:02:11 2021
...
def pascal(n, k):
    '''
    Devuelve el valor que se encuentra en la fila n y en la columna k del
    triangulo de pascal armado en la subfuncion triangulo_pascal de n+1 filas.
    n+1 porque se me iba de rango
    '''
    def triangulo_pascal(n):
        '''
        Funcion para armar el triangulo de pascal de n filas
        '''
        #número de filas = 0 => triangulo vacío.
        if n == 0:
            return []
        #número de filas = 1 => triangulo con 1 fila.
        elif n == 1:
            return [[1]]
        else:
             nueva_fila = [1]
             #llamo nuevamente a la función para armar el triángulo
             resultado = triangulo_pascal(n-1)
             #guardo la última fila.
             ultima_fila = resultado[-1]
             #itero la cantidad de veces del valor de filas - 1.
             for i in range(len(ultima_fila)-1):
             #agrego los valores a la nueva fila.
                 nueva_fila.append(ultima_fila[i] + ultima_fila[i+1])
             nueva_fila += [1]
            #agrego a la matriz del triángulo la nueva fila
             resultado.append(nueva_fila)
        #devuelvo el triángulo.
        return resultado
...
def combinaciones(lista, n):
    ...
    y un numero n, e imprime todas las posibles
